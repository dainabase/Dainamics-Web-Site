...
export const blogArticlesMeta: BlogArticleMeta[] = [
  ...
  { id: '37', slug: 'ia-services-financiers-finma', title: 'IA Services Financiers : Guidelines FINMA et Implémentation', excerpt: 'La FINMA encadre l\'usage de l\'IA dans la finance. Guidelines, cas d\'usage conformes et bonnes pratiques.', categoryId: 'conformite', authorId: 'equipe-dainamics', publishedAt: '2025-11-28', readTime: 11, featured: false, tags: ['finma', 'finance', 'banque', 'assurance', '
