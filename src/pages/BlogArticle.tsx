...
// Hero images par catégorie
const categoryHeroImages: Record<string, string> = {
  'strategie-ia': 'https://images.unsplash.com/photo-1677442136019-21780ecad995?w=1600&h=600&fit=crop',
  'automatisation': 'https://images.unsplash.com/photo-1518432031352-d6fc5c10da5a?w=1600&h=600&fit=crop',
  'cas-clients': 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=1600&h=600&fit=crop',
  'guides': 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=1600&h=600&fit=crop',
  'tendances': 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1600&h=600&fit=crop',
  'competitivite': 'https://images.unsplash.com/photo-1553028826-f4804a6dba3b?w=1600&h=600&fit=crop',
  'conformite': 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=1600&h=600&fit=crop'
};
...
const BlogArticle = () => {
  ...
  const heroImage = useMemo(() => 
    article?.image || categoryHeroImages[article?.categoryId || ''] || categoryHeroImages['strategie-ia'],
    [article]
  );
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {relatedArticles.map((related, index) => {
                  ...
                  const relatedHero = related.image || categoryHeroImages[related.categoryId] || categoryHeroImages['strategie-ia'];
                  return (
                    <motion.div
                      key={related.slug}
                      initial={{ opacity: 0, y: 20 }}
                        ...
                        <div className="h-full rounded-2xl bg-white/[0.02] border border-white/10 hover:border-white/20 hover:bg-white/[0.04] transition-all duration-300 overflow-hidden flex flex-col">
                          ...
                          <div className="relative h-40 overflow-hidden">
                            <div 
                              ...
                              style={{ backgroundImage: `url(${relatedHero})` }}
                            />
