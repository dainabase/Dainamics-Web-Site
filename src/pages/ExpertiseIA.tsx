    ...
    <div className="min-h-screen bg-dainamics-background">
      ...
      <section className="relative pt-32 pb-20 px-4 md:px-8 lg:px-16 overflow-hidden">
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(circle at top right, ${iaColor}40, transparent 50%)`
          }}
        />
        ...
        <motion.div
          ...
          style={{ backgroundColor: `${iaColor}10` }}
        />
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg text-dainamics-light/70 max-w-2xl mx-auto mb-8">
              {pillar.technologies.length} technologies de pointe pour créer vos solutions IA
            </p>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg text-dainamics-light/70 max-w-2xl mx-auto">
              {pillar.capabilities.length} services IA sur mesure pour votre entreprise
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg text-dainamics-light/70 max-w-2xl mx-auto">
              {pillar.useCases.length} exemples de projets IA avec ROI mesurable
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 md:px-8 lg:px-16 bg-gradient-to-b from-transparent to-dainamics-light/5">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg text-dainamics-light/70 max-w-2xl mx-auto">
              Démarrez rapidement avec nos projets IA à ROI rapide
            </p>
          </motion.div>
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-lg text-dainamics-light/70 mb-8 max-w-2xl mx-auto">
                Contactez-nous pour un diagnostic IA gratuit et découvrez comment 
                l'Intelligence Artificielle peut transformer votre entreprise
              </p>
